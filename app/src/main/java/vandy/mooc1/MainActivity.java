...
public class MainActivity extends LifecycleLoggingActivity {
    ...
    //http://www.smple.co/wp-content/uploads/2015/03/modern-art-design-design-basic-9-on-modern-design-ideas.jpg
    //http://www.dre.vanderbilt.edu/~schmidt/robot.png


    /**
     * For use as string message
     */
    static private final String CHOOSER_TEXT        = "Complete action using";
    static private final String MSG_PROBLEM_EXTRA   = "Same problem putting field as an extra!";
    static private final String MSG_PROBLEM_URL     = "Problem occurred at the given URL!";
    static private final String MSG_INVALID_URL     = "Invalid url!";




    /**
     * For use with putExtra
     */
    ...
    protected void onActivityResult(int requestCode,
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode ==  DOWNLOAD_IMAGE_REQUEST) {
                ...
                // file.
                // @@ TODO -- you fill in here.
                if (data.hasExtra(USER_DATA_EXTRA)) {
                    Intent galleryIntent = makeGalleryIntent(data.getExtras().get(USER_DATA_EXTRA).toString());
     ...
     */
    protected Uri getUrl() {Uri url = null;
        ...
        if (URLUtil.isNetworkUrl(url.toString()) == true &&
                Patterns.WEB_URL.matcher(url.toString()).matches() == true){
            Log.i(TAG, "Correct url");
            return url;
        }
        else {
            Toast.makeText(this,
